...
||can create phases under projects|so they can granuraly track project timelines|x|x|
...
|users|can sync projects to `cloud`|so they can access them on other devices or the web client|x|-|
...
||can add others to their collegues(friends) list|so they can build their network|-|x|
||can invite collegues to their projects as participants||-|x|
